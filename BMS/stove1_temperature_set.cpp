...
#include "ui_stove1_temperature_set.h"

bool Stove1_Temperature_Set::Stove1_temp_read_stop = false;

Stove1_Temperature_Set::Stove1_Temperature_Set(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Stove1_Temperature_Set)
{
    ui->setupUi(this);
}

Stove1_Temperature_Set::~Stove1_Temperature_Set()
{
    delete ui;
}

void Stove1_Temperature_Set::on_stove1_Temperature_Set_OkBtn_clicked()
{
    stove1_Temperature_Set();
}

void Stove1_Temperature_Set::stove1_Temperature_Set()
{
    this->close();
    Stove1_temp_read_stop = true;
    sleep(1000);
    if(ui->input_Start_Temperature->text()!="")
    {
        ...
        int parity_Hex=80*256+68+str_Stove.toFloat(0)*10;
    ...
    if(ui->input_Time1->text()!="")
    {
        ...
        int parity_Hex=81*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    if(ui->input_Terminal_Temperature1->text()!="")
    {
        ...
        int parity_Hex=82*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    if(ui->input_Time2->text()!="")
    {
        ...
        int parity_Hex=83*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    if(ui->input_Terminal_Temperature2->text()!="")
    {
        ...
        int parity_Hex=84*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    if(ui->input_Time3->text()!="")
    {
        ...
        int parity_Hex=85*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    if(ui->input_Terminal_Temperature3->text()!="")
    {
        ...
        int parity_Hex=86*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    if(ui->input_Time4->text()!="")
    {
        ...
        int parity_Hex=87*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    if(ui->input_Terminal_Temperature4->text()!="")
    {
        ...
        int parity_Hex=88*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    if(ui->input_Time5->text()!="")
    {
        ...
        int parity_Hex=89*256+68+str_Stove.toFloat(0)*10;
        int parity_L_Bit=parity_Hex%256;
        int parity_H_Bit=parity_Hex/256;
        str.append(parity_L_Bit);
        str.append(parity_H_Bit);
    ...
    Stove1_temp_read_stop = false;
}

void Stove1_Temperature_Set::on_stove1_Temperature_Set_QuitBtn_clicked()
{
    this->close();
}


void Stove1_Temperature_Set::sleep(unsigned int msec)
{
